"""xAI (Grok) Responses SSE event -> Anthropic Messages SSE event translation.

Pure functions, no I/O. Derives token scaling, usage, stop-reason, and content-filter
handling from the translate submodule.
"""
